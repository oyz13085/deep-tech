...
import { Search, TreePine, PenLine, Layers } from 'lucide-react';
...
export default function PalmScanPanel({ fields, selectedId, onSelect }: Props) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full px-6 py-12 text-center">
      ...
      <p className="text-xs text-gray-400 leading-relaxed">
        Click the <span className="font-medium text-gray-600">pencil icon</span> on the map to draw your first compartment.
      </p>
    </div>
  );
}
